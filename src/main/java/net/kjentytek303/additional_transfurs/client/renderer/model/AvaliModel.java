...
@OnlyIn(Dist.CLIENT)
public class AvaliModel extends AdvancedHumanoidModel<Avali>  {
	@Override
	public HumanoidAnimator<Avali, ?> getAnimator(Avali entity) { return animator; }
	...
	private final HumanoidAnimator<Avali, AvaliModel> animator;

//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(AdditionalTransfurs.modResource("entity/avali"), "main");
	...
	private final ModelPart LeftPad;
		...
		animator = HumanoidAnimator.of(this).hipOffset(-1.5f)
			   .addPreset(AnimatorPresets.birdLike(
					 ...
					 , LeftFlight, LeftSubFlight, RightFlight, RightSubFlight
