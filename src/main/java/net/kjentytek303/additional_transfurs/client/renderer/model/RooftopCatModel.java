...
@OnlyIn(Dist.CLIENT)
public class RooftopCatModel extends AdvancedHumanoidModel<RooftopCat>  {
	@Override
	public HumanoidAnimator<RooftopCat, ?> getAnimator(RooftopCat entity) { return animator; }
	...
	private final HumanoidAnimator<RooftopCat, RooftopCatModel> animator;

//	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(AdditionalTransfurs.modResource("entity/rooftop_cat"), "main");
	...
	private final ModelPart LeftArm;
		...
		public RooftopCatModel (ModelPart root) {
		super(root);
